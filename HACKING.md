...
hidden if the `sdp-tools-cpp_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `sdp-tools-cpp_DEVELOPER_MODE` to the configure
